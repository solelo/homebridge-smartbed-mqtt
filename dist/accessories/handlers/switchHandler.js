...
exports.BinarySensorHandler = exports.SwitchHandler = void 0;
 ...
 */
class SwitchHandler extends base_1.EntityHandler {
    constructor() {
        super(...arguments);
        this.isOn = false;
    }
 ...
 */
class BinarySensorHandler extends base_1.EntityHandler {
    constructor() {
        super(...arguments);
        this.detected = false;
    }
    ...
    setupService() {
        const { Service: S, Characteristic } = this.ctx.api.hap;
        const subtype = this.entity.objectId;
        const service = this.ctx.accessory.getServiceById(S.ContactSensor, subtype) ??
            this.ctx.accessory.addService(S.ContactSensor, this.friendlyName(), subtype);
        service.setCharacteristic(Characteristic.Name, this.friendlyName());
        service
            .getCharacteristic(Characteristic.ContactSensorState)
            .onGet(() => this.detected ? Characteristic.ContactSensorState.CONTACT_NOT_DETECTED : Characteristic.ContactSensorState.CONTACT_DETECTED);
        this.service = service;
        return service;
    }
    onTopicMessage(topic, payload) {
        ...
        this.service?.updateCharacteristic(Characteristic.ContactSensorState, this.detected ? Characteristic.ContactSensorState.CONTACT_NOT_DETECTED : Characteristic.ContactSensorState.CONTACT_DETECTED);
    }
}
exports.BinarySensorHandler = BinarySensorHandler;
//# sourceMappingURL=switchHandler.js.map