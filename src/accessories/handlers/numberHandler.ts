 ...
 */
export class NumberHandler extends EntityHandler {
  private percent = 0;
  ...
  setupService(): Service | undefined {
    ...
    const service =
      this.ctx.accessory.getServiceById(S.Fanv2, subtype) ?? this.ctx.accessory.addService(S.Fanv2, this.friendlyName(), subtype);
